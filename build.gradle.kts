...
tasks {
    ...
    shadowJar { archiveClassifier.set(""); archiveFileName.set("mEvents-${project.version}.jar"); relocate("org.bstats", "io.github.miklires.mevents.libs.bstats") }
...
modrinth {
    ...
    versionNumber.set(project.version.toString()); versionName.set("mEvents ${project.version}"); versionType.set("release")
